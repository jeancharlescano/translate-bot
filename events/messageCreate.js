...
export default {
  ...
  async execute(message, client) {
    ...
    if (message.author.id === "1214565174472609852" || message.channelId !== debugId && message.webhookId === null) {
      console.warn(`[${getTimestamp()}] 🚧 Message interne skip...`);
      return;
    }

    if (message.channelId !== patchesId && message.channelId !== announceId && message.channelId !== debugId) {
